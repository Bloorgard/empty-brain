...
## Фотограмметрия / Gaussian splat

[Гауссов сплэтинг: как это выглядит](https://habr.com/ru/articles/768590/)
- [jawset](https://www.jawset.com/ ) — локальное для win
- gaussian splat

## Карта глубины
- https://vesta.sh/ru/tools/depth-map/
- https://memedia.ru/spec/anima/
- https://gen-api.ru/model/midas
